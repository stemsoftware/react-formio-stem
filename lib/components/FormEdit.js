...
var FormEdit = /*#__PURE__*/function (_Component) {
  ...
  _createClass(FormEdit, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState, nextContext) {
      ...
      return this.state.form.DisplayLabel !== nextState.form.DisplayLabel || this.state.form.FormName !== nextState.form.FormName || this.state.form.Path !== nextState.form.Path || this.state.form.Display !== nextState.form.Display || this.state.form.Type !== nextState.form.Type;
    }
  }, {
    key: "render",
