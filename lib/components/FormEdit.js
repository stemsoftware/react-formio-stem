  ...
  _createClass(FormEdit, [{
    ...
    value: function handleChange(path, event) {
      ...
      this.setState(function (prev) {
        ...
        var newForm = (0, _omit2["default"])(form, ["path"]);
    ...
    value: function shouldComponentUpdate(nextProps, nextState, nextContext) {
      ...
      return this.state.form.category !== nextState.form.category || this.state.form.displayLabel !== nextState.form.displayLabel || this.state.form.name !== nextState.form.name || this.state.form.path !== nextState.form.path || this.state.form.display !== nextState.form.display || this.state.form.type !== nextState.form.type;
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("div", {
        ...
        onChange: function onChange(event) {
          return _this2.handleChange("category", event);
        }
      }))), /*#__PURE__*/_react["default"].createElement("div", {
        className: "col-lg-2 col-md-4 col-sm-4"
      }, /*#__PURE__*/_react["default"].createElement("div", {
